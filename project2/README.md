...
The data set has 200 samples and was made by first generating a set of 4 betas as the 
...
estimated by each method, and we can visually observe performances of these methods in
